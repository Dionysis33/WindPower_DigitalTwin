...
- respecting scientific rigor, reproducibility, and benchmark-safe interpretation,
- clearly distinguishing between implemented work, planned next steps, and future research,
- giving fair attribution to datasets, papers, software tools, and prior work,
- using clear and professional language,
- welcoming good-faith questions, corrections, and suggestions,
- avoiding exaggerated claims about results, models, diagnostics, graph methods, PHM, or digital-twin functionality.
...
- personal attacks,
- insulting, dismissive, or hostile language,
...
This Code of Conduct is inspired by common open-source community standards and adapted for the academic, research-oriented, forecasting-first, and thesis-facing nature of this repository.