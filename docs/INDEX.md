...
- `README.md`  
  Γενική επισκόπηση του current public repository state και του canonical end-to-end workflow μέχρι το `NB14`, με forecasting-first και benchmark-safe wording.
...
- **already implemented forecasting, diagnostics, graph-verification, graph-packaging, graph-baseline, graph-ablation, and controlled graph-refinement stages**
